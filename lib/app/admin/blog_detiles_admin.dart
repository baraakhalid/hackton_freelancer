...
class BlogDetilesAdmin extends StatefulWidget {
   BlogDetilesAdmin({Key? key,this.blog}) : super(key: key);
  final Blog? blog;

  @override
  State<BlogDetilesAdmin> createState() => _BlogDetilesAdminState();
}

class _BlogDetilesAdminState extends State<BlogDetilesAdmin> {
  ...
  //   ProcessResponse processResponse = await BlogGetxController.to.delete(index);
